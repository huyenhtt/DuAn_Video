	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto mb-2 mb-lg-0">
				<c:choose>
					<c:when test="${not empty curentUser}">
						<li class="nav-item"><a class="nav-link nav-link-1 active"
							aria-current="page" href="index">Trang của
								${sessionScope.curentUser.username}</a></li>
						...
						<c:if test="${curentUser.isAdmin==true}">
							<li class="nav-item"><a class="nav-link nav-link-2"
...
<div class="tm-hero d-flex justify-content-center align-items-center"
	style="height: 700px" data-parallax="scroll"
	data-image-src="/AssUI/template/user/img/dj.jpg">
